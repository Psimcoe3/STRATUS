...
| C# |
| --- |
| ``` public static ICollection<Alignment> GetAlignments( 	Document document ) ``` |

 

| Visual Basic |
| --- |
| ``` Public Shared Function GetAlignments ( _ 	document As Document _ ) As ICollection(Of Alignment) ``` |
