...
|  |
| --- |
| [PipeFittingAndAccessoryPressureDropUIDataItem Class](c1471c51-00e6-067b-164a-d00f4d66f97e.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
|  | Name | Description |
| --- | --- | --- |
| Public method | [Dispose](4496372d-3c06-0392-eb61-ef85f999c5ae.htm) | Releases all resources used by the  [PipeFittingAndAccessoryPressureDropUIDataItem](c1471c51-00e6-067b-164a-d00f4d66f97e.htm) |
...
| Public method | [GetEntity](2f04d05b-420e-04d3-60b9-85bb3a031346.htm) | Returns the entity set by UI server. or an invalid entity otherwise. |
...
| Public method | [GetPipeFittingAndAccessoryData](d041a923-d03e-261c-1cb8-ded10b40284d.htm) | Gets the fitting data stored in the UI data item. |
...
| Public method | [SetEntity](265367e2-84e2-bb33-3dce-7ffa6d6b3bcf.htm) | Stores the entity in the UI data item. |
...
|  | Name | Description |
| --- | --- | --- |
| Public property | [IsValidObject](4486eb34-a102-5010-903b-0a85b3c8ec56.htm) | Specifies whether the .NET object represents a valid Revit entity. |
