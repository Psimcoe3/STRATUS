...
|  |
| --- |
| [Members](aa3e5ec6-46c5-932a-af54-aebdf5560c63.htm)   [See Also](#seeAlsoToggle) |
...
| Visual Basic |
| --- |
| ``` Public Class DuctSizeSettingIterator _ 	Implements IEnumerator(Of KeyValuePair(Of DuctShape, DuctSizes)) ``` |
...
[System Object](http://msdn2.microsoft.com/en-us/library/e5kfa45b)    
  Autodesk.Revit.DB.Mechanical DuctSizeSettingIterator

# See Also

[DuctSizeSettingIterator Members](aa3e5ec6-46c5-932a-af54-aebdf5560c63.htm)
