...
|  |
| --- |
| [IdlingEventArgs Class](92e2300b-b4b1-af35-221a-cfbeb22c8705.htm)   [Methods](#methodTableToggle)   [Properties](#propertyTableToggle)   [See Also](#seeAlsoToggle) |
...
| Public method | [SetRaiseWithoutDelay](6ead2453-9221-9044-0d93-84cc7db00b0d.htm) | Sets the next invocation of the idling event to be called promptly, rather than relying on the default recurrence of idling from the Revit application. For more details see the remarks describing the Idling event. |
