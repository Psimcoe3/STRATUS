...
|  |
| --- |
| [Members](c57f0510-9b53-7f6d-711d-7144436e9d9a.htm)   [See Also](#seeAlsoToggle) |
...
| Visual Basic |
| --- |
| ``` Public Class AssetSet _ 	Inherits APIObject _ 	Implements IEnumerable ``` |

 

| Visual C++ |
| --- |
| ``` public ref class AssetSet : public APIObject,  	IEnumerable ``` |
...
[AssetSet Members](c57f0510-9b53-7f6d-711d-7144436e9d9a.htm)
