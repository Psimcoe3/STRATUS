...
| Visual Basic |
| --- |
| ``` Public Property AnalysisType As AnalysisMode 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property AnalysisMode AnalysisType { 	AnalysisMode get (); 	void set (AnalysisMode value); } ``` |

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.htm) | When setting this property: The analysis type does not fall within an appropriate range. |
