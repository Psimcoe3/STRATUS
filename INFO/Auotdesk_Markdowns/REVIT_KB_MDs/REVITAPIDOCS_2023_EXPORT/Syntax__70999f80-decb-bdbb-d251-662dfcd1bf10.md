...
| Visual Basic |
| --- |
| ``` Public Property MaxRiserHeight As Double 	Get 	Set ``` |

 

| Visual C++ |
| --- |
| ``` public: property double MaxRiserHeight { 	double get (); 	void set (double value); } ``` |

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.htm) | When setting this property: The given value for maxRiserHeight must be greater than 0 and no more than 30000 feet. |
